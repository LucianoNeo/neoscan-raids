...
export default function Header() {
    return (
        <header className="flex items-center h-16 lg:h-12 sticky top-0 bg-slate-900 text-white overflow-hidden lg:w-[100vw] w-[165vw]">
            <Image src={Rotom} alt="rotom" width={80} height={70} className='translate-y-2 bg-slate-900 z-50' />
