  ...
  return (
    <Dialog.Portal>
      ...
      <Dialog.Content className="fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg md:w-[480px] shadow-black/25 z-20 overflow-hidden w-[95%] ">
        <Dialog.Title className="md:text-3xl text-5xl font-black">
          Agende uma Raid
        </Dialog.Title>
        <form className="flex flex-col gap-4" onSubmit={handleCreateAd}>
          ...
          <div className="flex w-full justify-between md:text-xs text-2xl">
            <div className="flex flex-col">
              ...
              <strong className=" block text-blue-500 md:text-lg text-5xl">
                {props.min}
              </strong>
            </div>
            <div className="flex flex-col gap-2 items-end justify-between">
              ...
              <input
                ...
                id="hourStart"
                min={props.min}
                className="bg-zinc-900 rounded md:py-2.5 py-4 px-4 md:text-sm text-2xl placeholder:text-zinc-500 "
              />
            </div>
          </div>

          <footer className="mt-4 flex justify-end gap-4">
            <Dialog.Close className="bg-zinc-500 md:px-5 px-10 md:h-12 h-20 rounded-md font-semibold hover:bg-zinc-600 md:text-sm text-3xl">
              Cancelar
            </Dialog.Close>
            <button
